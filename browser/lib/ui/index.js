...
var create = function create(_ref) {
  ...
  on(fileInput, 'change', function (e) {
    return emit(UI_FILES_CHANGE, fileInput.files, METHOD_FILE_INPUT);
  });
  ...
  if (hasDnd) {
    ...
    on(form, 'drop', function (e) {
      return emit(UI_FILES_CHANGE, e.dataTransfer.files, METHOD_DRAG_AND_DROP);
    });
  }
...
export var METHOD_FILE_INPUT = 'fileInput';
